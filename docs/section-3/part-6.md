## What's next ser (to be optimized)
...
## Phases
Good Vibes Ohmly launches in three phases, the first phase is staking and bonding launching at the same time as the genesis drop. We’re launching season zero : genesis drop, staking, and bonding on TBC
